...
2. Ask: "Would you like to start with a feature specification? Running `/agent`, choosing `sdd.specify`, will create a structured spec with user stories and requirements. Or I can proceed directly."
