...
The `flow` plugin looks for a **plain YAML file** (not markdown)
...
|-------------------|--------------------------------------------------------------------------------------------------------|-------------------------------------------------------|
| `planner`         | plan                                                                                 | Produces and revises planning artifacts               |
| `implementer`     | parallel-impl, pr-resolve                                               | Makes code changes                                    |
| `reviewer`        | plan, parallel-impl, pr-resolve                       | Reviews plans or diffs                                |
| `structured-check`| pr-ready                                                                                | Runs structured code checks                           |
| `final-reviewer`  | pr-ready                                                                                | Whole-diff final review                               |
| `scout`           | plan, parallel-impl, pr-resolve, pr-ready | Runs bounded discovery/triage before expensive delegation |
