...
- local test failures or development-time bugs (use `systematic-debugging`);
- architecture health reviews (use `architecture-review`);
- proactive test generation (use `e2e-test-generation`).
