...
- after `/workflow-orchestration:map-codebase` has run and the developer wants deeper analysis;
...
- whether the `arch-check` skill (from `clean-code-codex`) is available in the current session;
